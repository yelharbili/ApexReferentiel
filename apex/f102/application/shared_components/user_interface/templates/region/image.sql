...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3501742222471031)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3502050723471031)
,p_plug_template_id=>wwv_flow_imp.id(3501742222471031)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3502357713471031)
,p_plug_template_id=>wwv_flow_imp.id(3501742222471031)
,p_name=>'Sub Regions'

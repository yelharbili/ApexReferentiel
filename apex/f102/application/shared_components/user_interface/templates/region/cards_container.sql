...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3472015354470951)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3472305798470953)
,p_plug_template_id=>wwv_flow_imp.id(3472015354470951)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3472645739470953)
,p_plug_template_id=>wwv_flow_imp.id(3472015354470951)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3472966384470953)
,p_plug_template_id=>wwv_flow_imp.id(3472015354470951)
,p_name=>'Sub Regions'

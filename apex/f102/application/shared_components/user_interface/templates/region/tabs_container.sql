...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3541305340471137)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3541662784471137)
,p_plug_template_id=>wwv_flow_imp.id(3541305340471137)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3541987190471137)
,p_plug_template_id=>wwv_flow_imp.id(3541305340471137)
,p_name=>'Tabs'

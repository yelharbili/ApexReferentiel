...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3526331579471096)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3526625734471096)
,p_plug_template_id=>wwv_flow_imp.id(3526331579471096)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3526925534471098)
,p_plug_template_id=>wwv_flow_imp.id(3526331579471096)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3527285434471098)
,p_plug_template_id=>wwv_flow_imp.id(3526331579471096)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3527514780471100)
,p_plug_template_id=>wwv_flow_imp.id(3526331579471096)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3527821684471100)
,p_plug_template_id=>wwv_flow_imp.id(3526331579471096)
,p_name=>'Sub Regions'

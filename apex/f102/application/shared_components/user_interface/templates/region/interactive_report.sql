...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3521737664471084)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3522042843471085)
,p_plug_template_id=>wwv_flow_imp.id(3521737664471084)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3522367363471085)
,p_plug_template_id=>wwv_flow_imp.id(3521737664471084)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3522690396471087)
,p_plug_template_id=>wwv_flow_imp.id(3521737664471084)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3522908835471090)
,p_plug_template_id=>wwv_flow_imp.id(3521737664471084)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3523278034471090)
,p_plug_template_id=>wwv_flow_imp.id(3521737664471084)
,p_name=>'Sub Regions'

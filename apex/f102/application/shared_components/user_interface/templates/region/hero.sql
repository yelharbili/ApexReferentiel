...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3498201531471017)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3498560165471021)
,p_plug_template_id=>wwv_flow_imp.id(3498201531471017)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3498891907471023)
,p_plug_template_id=>wwv_flow_imp.id(3498201531471017)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3499103916471025)
,p_plug_template_id=>wwv_flow_imp.id(3498201531471017)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3499497139471026)
,p_plug_template_id=>wwv_flow_imp.id(3498201531471017)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3499731914471026)
,p_plug_template_id=>wwv_flow_imp.id(3498201531471017)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false

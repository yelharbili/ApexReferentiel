...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3528851809471104)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3529125853471104)
,p_plug_template_id=>wwv_flow_imp.id(3528851809471104)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3529424826471104)
,p_plug_template_id=>wwv_flow_imp.id(3528851809471104)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3529799766471106)
,p_plug_template_id=>wwv_flow_imp.id(3528851809471104)
,p_name=>'Sub Regions'

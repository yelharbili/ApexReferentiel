...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3493657450471004)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3493929178471006)
,p_plug_template_id=>wwv_flow_imp.id(3493657450471004)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3494253067471006)
,p_plug_template_id=>wwv_flow_imp.id(3493657450471004)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3494584155471007)
,p_plug_template_id=>wwv_flow_imp.id(3493657450471004)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3494891839471007)
,p_plug_template_id=>wwv_flow_imp.id(3493657450471004)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3495153699471007)
,p_plug_template_id=>wwv_flow_imp.id(3493657450471004)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3495414789471009)
,p_plug_template_id=>wwv_flow_imp.id(3493657450471004)
,p_name=>'Sub Regions'

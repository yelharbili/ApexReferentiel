...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3523827719471092)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3524160292471092)
,p_plug_template_id=>wwv_flow_imp.id(3523827719471092)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3524449367471093)
,p_plug_template_id=>wwv_flow_imp.id(3523827719471092)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3524729228471093)
,p_plug_template_id=>wwv_flow_imp.id(3523827719471092)
,p_name=>'Button Start'

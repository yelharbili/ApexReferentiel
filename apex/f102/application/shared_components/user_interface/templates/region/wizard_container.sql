...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3549087341471151)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3549309285471151)
,p_plug_template_id=>wwv_flow_imp.id(3549087341471151)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3549648087471153)
,p_plug_template_id=>wwv_flow_imp.id(3549087341471151)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3549928651471153)
,p_plug_template_id=>wwv_flow_imp.id(3549087341471151)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3550254539471153)
,p_plug_template_id=>wwv_flow_imp.id(3549087341471151)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3550571401471153)
,p_plug_template_id=>wwv_flow_imp.id(3549087341471151)

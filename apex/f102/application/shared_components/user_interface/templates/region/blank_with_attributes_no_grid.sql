...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3466332750470939)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3466677628470939)
,p_plug_template_id=>wwv_flow_imp.id(3466332750470939)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3466924865470940)
,p_plug_template_id=>wwv_flow_imp.id(3466332750470939)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3467277666470942)
,p_plug_template_id=>wwv_flow_imp.id(3466332750470939)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3467514113470942)
,p_plug_template_id=>wwv_flow_imp.id(3466332750470939)
,p_name=>'Sub Regions'

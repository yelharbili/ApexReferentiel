...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3464920942470935)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3465205015470937)
,p_plug_template_id=>wwv_flow_imp.id(3464920942470935)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3465579376470937)
,p_plug_template_id=>wwv_flow_imp.id(3464920942470935)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3465883839470937)
,p_plug_template_id=>wwv_flow_imp.id(3464920942470935)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3466192873470939)
,p_plug_template_id=>wwv_flow_imp.id(3464920942470935)
,p_name=>'Sub Regions'

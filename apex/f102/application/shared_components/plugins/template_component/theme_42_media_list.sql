...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3661745615472215)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1803679603802355871)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1803680158814355872)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3662473868472229)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3662751097472232)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3663037032472234)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3663336091472235)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3663651716472239)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(3663037032472234)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1803680158814355872)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3663907432472240)
,p_plugin_attribute_id=>wwv_flow_imp.id(3663651716472239)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3664383726472243)
,p_plugin_attribute_id=>wwv_flow_imp.id(3663651716472239)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3664736715472245)
,p_plugin_attribute_id=>wwv_flow_imp.id(3663651716472239)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3665104504472248)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(3663651716472239)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3665432655472250)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3665796484472251)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3666070352472254)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3666326816472256)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3666662955472257)
,p_plugin_attribute_id=>wwv_flow_imp.id(3666326816472256)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3667070163472260)
,p_plugin_attribute_id=>wwv_flow_imp.id(3666326816472256)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3667466125472264)
,p_plugin_attribute_id=>wwv_flow_imp.id(3666326816472256)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3667844487472265)
,p_plugin_attribute_id=>wwv_flow_imp.id(3666326816472256)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3668200963472268)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(3663336091472235)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1803679603802355871)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3668505555472270)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3668898707472273)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3669115347472276)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3669482935472278)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3669702030472279)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3670014939472282)
,p_plugin_attribute_id=>wwv_flow_imp.id(3669702030472279)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3670480180472284)
,p_plugin_attribute_id=>wwv_flow_imp.id(3669702030472279)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3670896567472287)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3671126969472290)
,p_plugin_attribute_id=>wwv_flow_imp.id(3670896567472287)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3671546887472292)
,p_plugin_attribute_id=>wwv_flow_imp.id(3670896567472287)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3671917496472295)
,p_plugin_attribute_id=>wwv_flow_imp.id(3670896567472287)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3672302705472298)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3672695720472300)
,p_plugin_attribute_id=>wwv_flow_imp.id(3672302705472298)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3673090813472303)
,p_plugin_attribute_id=>wwv_flow_imp.id(3672302705472298)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3673453056472304)
,p_plugin_attribute_id=>wwv_flow_imp.id(3672302705472298)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3673838731472306)
,p_plugin_attribute_id=>wwv_flow_imp.id(3672302705472298)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3674224055472309)
,p_plugin_attribute_id=>wwv_flow_imp.id(3672302705472298)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3674643668472312)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3674992037472314)
,p_plugin_attribute_id=>wwv_flow_imp.id(3674643668472312)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3675323212472315)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1803883210971502500)
,p_plugin_id=>wwv_flow_imp.id(3661745615472215)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10

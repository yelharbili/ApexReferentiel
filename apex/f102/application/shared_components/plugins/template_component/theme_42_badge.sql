...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(3615882635471746)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3616114358471757)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3616423548471759)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3616755964471760)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3617074467471762)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3617363319471764)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3617659383471767)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3617935603471770)
,p_plugin_attribute_id=>wwv_flow_imp.id(3617659383471767)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3618352872471773)
,p_plugin_attribute_id=>wwv_flow_imp.id(3617659383471767)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3618765532471775)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3619037681471778)
,p_plugin_attribute_id=>wwv_flow_imp.id(3618765532471775)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3619446274471779)
,p_plugin_attribute_id=>wwv_flow_imp.id(3618765532471775)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3619898582471782)
,p_plugin_attribute_id=>wwv_flow_imp.id(3618765532471775)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(3620205055471785)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3620578394471787)
,p_plugin_attribute_id=>wwv_flow_imp.id(3620205055471785)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3620981630471789)
,p_plugin_attribute_id=>wwv_flow_imp.id(3620205055471785)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(3621393655471792)
,p_plugin_attribute_id=>wwv_flow_imp.id(3620205055471785)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1515098093869573945)
,p_plugin_id=>wwv_flow_imp.id(3615882635471746)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
